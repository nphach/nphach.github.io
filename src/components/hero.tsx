...
function Hero() {
    ...
    return (
        <section id="home" className="bg-gradient-to-b from-[#D3DAE9] to-white h-full w-full flex justify-center">
            ...
            {!isMobile &&
                <div className="basis-1/2">
                    <div ref={containerRef} className="bg-zinc-900 basis-1/2 h-full relative overflow-hidden">
